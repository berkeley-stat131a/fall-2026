...
The course will teach a broad range of statistical methods that are used to solve data problems, including group comparisons, standard parametric statistical models, multivariate data visualization, and multiple linear regression and classification.
...
- For security reasons, Zoom links for OH are posted on [bcourses](https://bcourses.berkeley.edu/courses).
...
<!-- - Please [create a private Ed post](https://edstem.org/us/dashboard) if you have conflicts with all of the scheduled OH.  -->
...
### Optional (and free!) Group Tutoring 🗓️
...
Students who wish to audit the course can also fill out the top portion of this form to get their email added to [bcourses](https://bcourses.berkeley.edu/courses) as a guest. 
Only name and email is needed for auditors. -->

## Course platforms 🖥️

[bcourses](https://bcourses.berkeley.edu/courses) will only be used for secure course material, like exam solutions, grades, and office hour Zoom links.

All other course materials will be posted on [the public course homepage](https://stat131a.berkeley.edu/fall-2026).

Assignments should be submitted via [Pensive](https://www.pensive.com).

All course communication will take place via [Ed](https://edstem.org/us/dashboard).
...
- [This article](https://www.nytimes.com/2017/11/22/business/laptops-not-during-lecture-or-meeting.html) explains why we have the laptop policy. Long story short, laptop use can negatively impact the learning of nearby students (i.e., this policy is not intended to punish you; the policy prevents you from punishing others).
...
- Lecture recordings are posted on [bcourses](https://bcourses.berkeley.edu/courses).
...
### Neighbor discussions (5% of grade + 2% bonus) 🗣️
...
- All homework assignments will be submitted via [Pensive](https://www.pensive.com) and are due by 11:59 pm of the due date.
...
<!-- **If you cannot attend an exam due to an extenuating circumstance, please make a private Ed post ASAP to determine whether your circumstance qualifies for a make-up exam.** -->

## ~~Prerequisite Quiz and~~ Midterms ⌛

Midterms are all 50-minutes. They will take place in the [computer-based testing facility (CBTF)](https://rtl.berkeley.edu/services-programs/computer-based-testing-facility-cbtf). 

You will sign up for a slot on [PrairieTest](https://us.prairietest.com/).
...
The prerequisite quiz has been cancelled. Homework is now worth 20% of your grade.
...
- ~~You can practice the prerequisite quiz on [PrairieLearn](https://us.prairielearn.com/).~~
...
We use the [Ed platform](https://edstem.org/us/dashboard) to manage course questions and discussion, and to make announcements.
...
- As in Data 8 and Stat 20, labs and assignments will be distributed via [DataHub](https://stat.datahub.berkeley.edu/).
...
If time permits, decision trees and random forests.
...
**If you already have a Letter of Accommodation, please open a private [Ed post](https://edstem.org/us/dashboard
) ASAP and attach your LoA.** 
...
- You can find more information about the DSP application process [here](https://edstem.org/us/dashboard). 
